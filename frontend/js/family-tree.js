...
$(document).ready(function() {
    ...
    $('#rootPersonSelect').on('change', function() {
        ...
        if (rootId) {
            ...
            $('#familyTreeContainer').html('<div class="text-center"><p class="text-muted">Pilih person untuk menampilkan family tree</p></div>');
        }
    });
    ...
    function populateRootSelect(persons) {
        ...
        select.empty();
        select.append('<option value="">Pilih Person</option>');
