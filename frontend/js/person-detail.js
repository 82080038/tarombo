        ...
        $('#personDetail').html(`
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <button class="btn btn-primary btn-block mb-2" onclick="alert('Fitur edit segera hadir')">Edit</button>
                        <button class="btn btn-info btn-block mb-2" onclick="window.location.href='family-tree.html?root=${person.id}'">Lihat Pohon Tarombo</button>
                        <button class="btn btn-warning btn-block" onclick="alert('Fitur Partuturan segera hadir')">Hitung Partuturan</button>
                    </div>
                </div>
            </div>
        `);
